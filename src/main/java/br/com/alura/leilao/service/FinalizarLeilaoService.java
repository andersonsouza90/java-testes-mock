...
public class FinalizarLeilaoService {
	...
	//Colocar o @autowired em um contrutor para que possamos utilizar o mock
	//Injetor de dependências (@Autowired) sempre pelo construtor para favorecer o uso testes
	@Autowired
	...
	private Lance maiorLanceDadoNoLeilao(Leilao leilao) {
		...
		//Ajuste necessário para rodar o teste
